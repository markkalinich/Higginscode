...
Mature_probabilityv   = linspace(0,1,3); %explore probability from 0 to 1
Mature_probability    = Mature_probabilityv(j); %fraction of band cells in blood that will mature after 1 day
