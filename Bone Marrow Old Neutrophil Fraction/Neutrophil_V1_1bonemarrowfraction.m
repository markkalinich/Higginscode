...
for j = 1:5
time                  = 1:5000; %number of time steps, in minutes
...
xlabel ('time (minutes)')
ylabel ('Neutrophils')
title (strcat('Neutrophils vs. Time, Const. Tot. Death Rate, Bone Young Neutrophil Fraction =',num2str(Young_fractionv(j))))
legend ('Mature Neutrophils','Band Neutrophils')

%saveas(fig,strcat('Neutrophil_Kinetics_Bone_Young_Neutrophil_Fraction=_',num2str(Young_fractionv(j))),'jpeg')
